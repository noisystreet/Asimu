...
#[test]
fn cuda_backend_lusgs_sweep_single_tet_passes_validate() {
    let mut case = parse_case_str(
        r#"
name = "unstructured_cuda_lusgs_sweep_validate"
[numerics]
compute_precision = "f32"
backend = "cuda"
[mesh]
...
"#,
    ...
    .expect("parse");
    attach_single_tet_farfield(&mut case);
    validate::exec_backend(&case).expect("cuda lu_sgs sweep validate");
}

#[test]
#[ignore = "gpu"]
fn runs_single_tet_unstructured_cuda_lusgs_sweep_smoke_step() {
    let mut case = parse_case_str(
        r#"
name = "unstructured_cuda_lusgs_sweep_smoke"
[numerics]
compute_precision = "f32"
backend = "cuda"
[mesh]
...
#[test]
fn cuda_backend_dual_time_sweep_single_tet_passes_validate() {
    let mut case = parse_case_str(
        r#"
name = "unstructured_cuda_dual_time_sweep_validate"
[numerics]
compute_precision = "f32"
backend = "cuda"
[mesh]
...
"#,
    ...
    .expect("parse");
    attach_single_tet_farfield(&mut case);
    validate::exec_backend(&case).expect("cuda dual_time sweep validate");
}

#[test]
#[ignore = "gpu"]
fn runs_single_tet_unstructured_cuda_dual_time_sweep_smoke_step() {
    let mut case = parse_case_str(
        r#"
name = "unstructured_cuda_dual_time_sweep_smoke"
[numerics]
compute_precision = "f32"
backend = "cuda"
[mesh]
...
"#,
    ...
    assert!(
        metrics.residual_log10 <= -2.0,
        "cuda dual_time sweep freestream should converge: log10={}",
        metrics.residual_log10
    );
    assert!(metrics.inner_iterations > 0);
}
