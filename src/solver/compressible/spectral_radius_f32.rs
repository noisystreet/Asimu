...
/// 按配置选择常规或低马赫预处理面谱半径（f32；P2–P3 与对角 \(\sigma^\text{LM}\) 一致）。
#[must_use]
pub(crate) fn face_spectral_radius_f32_with_low_mach(
    ...
    super::low_mach_face_spectral::face_spectral_radius_f32_with_low_mach_unified(
        left, right, normal, gamma, low_mach,
    )
}
