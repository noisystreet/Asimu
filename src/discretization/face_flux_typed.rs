...
use crate::discretization::{GhostCellState, face_inviscid_flux_from_interface};
...
pub(crate) fn dispatch_inviscid_flux_primitives_f32(
    ...
    match config.scheme {
        ...
        FluxScheme::Slau2 => dispatch_slau2_f64_bridge(prim_l, prim_r, normal, eos, config),
    }
}

fn dispatch_slau2_f64_bridge(
    prim_l: &PrimitiveStateF32,
    prim_r: &PrimitiveStateF32,
    normal: Vector3,
    eos: &IdealGasEoS,
    ...
    face_inviscid_flux_from_interface(
        InterfacePrimitiveStates {
            left: primitive_state_f32_to_real(*prim_l),
            right: primitive_state_f32_to_real(*prim_r),
        },
        normal,
        eos,
        config,
