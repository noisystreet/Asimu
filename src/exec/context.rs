...
impl ExecutionContext {
    ...
    /// CUDA：积分后仅失效原变量/BC device 状态（保留守恒场驻留）。
    #[cfg(feature = "cuda")]
    pub fn mark_cuda_primitives_stale_after_integration(&mut self) {
        self.backend_state
            .mark_cuda_primitives_stale_after_integration();
    }
