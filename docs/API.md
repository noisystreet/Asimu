...
| `lu_sgs_sweep_unstructured_f32` | 非结构 f32 LU-SGS 双扫（`lusgs_couplings_f32`；source/耦合差分/正性限制全 f32）；CUDA：`lusgs_sweep_unstructured_serial_f32` device 前/后扫 + host stabilize |
